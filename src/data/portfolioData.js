...
projects: [
  ...
  skills: [
    ...
    },
    {
      ...
      items: ["Figma (Lo-Fi & Hi-Fi)", "Pembuatan Wireframe", "Pemetaan Alur Pengguna", "Desain UI/UX", "Desain Berpusat pada Pengguna", "Interaksi Manusia dan Komputer (HCI)", "Pengujian Kebergunaan"]
    },
    {
      category: "Bisnis & Konsultasi",
      items: ["Manajemen Pemangku Kepentingan", "Riset Pengguna", "Analisis Kompetitor", "Design Thinking", "Analisis Kebutuhan Bisnis", "Analisis Kesenjangan (Gap Analysis)", "Peningkatan Proses", "Transformasi Digital", "Pengambilan Keputusan Berbasis Data", "Kepatuhan Regulasi"]
    },
    {
      category: "Infrastruktur Jaringan",
      items: ["TCP/IP", "DNS & DHCP", "Konfigurasi VLAN & Switch", "Perutean (OSPF, BGP)", "LAN/WAN", "Jaringan Nirkabel", "Subnetting", "Firewall", "VPN", "Cisco"]
    },
    {
      category: "Keahlian Teknis TI",
      items: ["Komputasi Awan (Cloud Computing)", "Keamanan Siber", "Literasi Kecerdasan Buatan (AI)", "Rekayasa Perangkat Lunak", "Manajemen Basis Data", "Pengembangan Aplikasi Seluler", "Perdagangan Elektronik (E-Commerce)", "Sistem Terdistribusi", "Sistem Operasi"]
    },
    {
      category: "Keterampilan Lunak & Bahasa",
      items: ["Pemecahan Masalah", "Pemikiran Analitis", "Perencanaan Strategis", "Kolaborasi Lintas Fungsi", "Kepemimpinan", "Bahasa Indonesia (Penutur Asli)", "Bahasa Inggris (Kecakapan Kerja Profesional)"]
    }
  ]
};